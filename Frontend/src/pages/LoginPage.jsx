...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#ffffff] p-6 font-sans">
            {/* Header */}
            <h1 className="text-[32px] font-bold text-[#111827] mb-8 tracking-tight">Sign in</h1>
                ...
                <CardContent className="p-10">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#" className="text-[13px] text-[#6b7280] hover:text-black transition-colors">Forgot?</a>
                            </div>
                            <Input
                                id="password"
                                name="password"
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-[15px] text-[#4b5563]">
                            ...
                            <Link to="/signup" className="text-[#111827] font-semibold hover:underline decoration-1 underline-offset-2">
                                Create account
                            </Link>
                        </p>
                    </div>
